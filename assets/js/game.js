...
starshipImage.src = "/assets/img/starship.png";

const torpedoImage = new Image();
torpedoImage.src = "/assets/img/torpedo.svg";

const asteroidBigImage = new Image();
asteroidBigImage.src = "/assets/img/asteroid-big.svg";

const asteroidMediumImage = new Image();
asteroidMediumImage.src = "/assets/img/asteroid-medium.svg";

const asteroidSmallImage = new Image();
asteroidSmallImage.src = "/assets/img/asteroid-small.svg";
